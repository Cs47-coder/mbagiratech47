...
import { Mail, Phone, MapPin, Send, Loader2, CheckCircle, AlertTriangle, MessageCircle, Apple as WhatsApp } from 'lucide-react';
...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const mailtoLink = `mailto:castormbagira9@gmail.com?subject=${encodeURIComponent(formData.subject || 'New Contact Form Submission')}&body=${encodeURIComponent(
